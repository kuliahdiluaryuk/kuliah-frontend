  ...
  return (
    ...
    >
      <div className="flex flex-row pt-3 gap-2 items-center relative">
        <div
          className={`w-2 h-4 bg-gray-800 absolute left-2 ${
        ...
        <input
          ref={inputRef}
          className={`w-full text-xs caret-transparent bg-transparent opacity-25 text-gray-300 p-2 pr-6 rounded-sm focus:opacity-100 focus:outline-none focus:border-gray-700 focus:ring-1 focus:ring-gray-700`}
          style={{
        ...
        <button
          ...
          onClick={handleSend}
          className={`text-xs uppercase text-gray-500 hover:bg-gray-950 p-2 rounded-md opacity-${
